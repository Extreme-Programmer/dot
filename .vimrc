" vim-bootstrap 2022-08-17 13:13:49
...
let g:vim_bootstrap_langs = "c,elixir,go,haskell,html,javascript,lisp,lua,ocaml,perl,php,python,ruby,rust,scala,typescript"
...
" vim-airline
let g:airline_theme ='nord' " 'powerlineish'
...
set splitbelow splitright mouse=a
...
nmap <LEADER>C :echo "S-C pressed" <CR>
nmap <LEADER>c :echo "C pressed" <CR>
